...
public class OrdenadorDAO implements InterfazOrdenadorDAO {
    ...
    @Override
    public boolean actualizarOrdenadorPorId(Ordenador ordenador) {
        PreparedStatement preparedStatement = null;
        String sql = "UPDATE portatil SET ram = ?, ssd = ?, pantalla = ? WHERE id = ?;";
        int resultado = 0;
        try {
            preparedStatement = conexion.prepareStatement(sql);
            preparedStatement.setInt(1, ordenador.getRam());
            ...
            preparedStatement.setInt(4, ordenador.getId());
            resultado = preparedStatement.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
    ...
    @Override
    public boolean borrarOrdenadorPorId(int id) {
        PreparedStatement preparedStatement = null;
    ...
    @Override
    public boolean crearOrdenador(Ordenador ordenador) throws OrdenadorException {
        PreparedStatement preparedStatement = null;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------");
        try {
            System.out.printf("Insertado de nuevo ordenador: %B%n", ordenadorDAO.crearOrdenador(new Ordenador(100, 100, 100)));
